...
{
    Task<Result<PagedResultDto<GroupMemberResponseDto>>> GetMembersAsync(Guid groupId, Guid currentUserId, PaginationParams pagination, CancellationToken cancellationToken = default);
